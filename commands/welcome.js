module.exports = (client) => {
    ...
    client.on('guildMemberAdd', (member) => {
        ...
        channel.send(`Hello <@${member.id}> Welcome to **TjSploits**. Thanks for joining our server. Please read the rules here ${member.guild.channels.cache.get(targetChannelID).toString()}Have fun! Your also member #${guild.memberCount}!`) // Custom Welcome Message
        })
    }
